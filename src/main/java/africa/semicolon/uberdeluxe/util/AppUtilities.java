...
public class AppUtilities {
    ...
    public final static String WELCOME_MAIL_TEMPLATE_LOCATION="C:\\Users\\user\\Downloads\\uberdeluxe\\uberdeluxe\\src\\main\\resources\\welcome.txt";
    public final static String ADMIN_INVITE_MAIL_TEMPLATE_LOCATION="C:\\Users\\user\\Downloads\\uberdeluxe\\uberdeluxe\\src\\main\\resources\\adminMail.txt";

    public static String getMailTemplate(){
        try (BufferedReader reader = new BufferedReader(new FileReader(WELCOME_MAIL_TEMPLATE_LOCATION))){
    ...
    public static String getAdminMailTemplate(){
        try (BufferedReader reader = new BufferedReader(
                new FileReader(ADMIN_INVITE_MAIL_TEMPLATE_LOCATION))){
            return reader.lines().collect(Collectors.joining());
        }catch (IOException exception){
            throw new BusinessLogicException(exception.getMessage());
        }
